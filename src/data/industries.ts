...
export const industriesDataDe: CleanroomIndustry[] = [
  {
...
export const industriesDataEn: CleanroomIndustry[] = [
  {
    id: "pharmaceutical-biotech",
    slug: "pharmaceutical-biotech",
...
export function getLocalizedIndustries(lang: Language = "de"): CleanroomIndustry[] {
  return lang === "en" ? industriesDataEn : industriesDataDe;
}

export const industriesData = industriesDataDe;

export function getIndustryBySlug(slug: string, lang: Language = "de"): CleanroomIndustry | undefined {
